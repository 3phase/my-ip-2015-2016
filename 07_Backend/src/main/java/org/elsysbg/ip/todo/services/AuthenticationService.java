...
public class AuthenticationService {
	...
	private final Provider<MemberService> memberService;
	
	@Inject
	public AuthenticationService(Provider<MemberService> memberService) {
		this.memberService = memberService;
	}

	public Member getCurrentlyLoggedUser(Subject subject) {
		final String username = (String) subject.getPrincipal();
		if (username == null) {
			return null;
		}
		return memberService.get().getMemberByUsername(username);
	}
